...
in lib // (rec {
  ...
  hithrocKey = "ssh-rsa  hithroc@x240-laptop-2017-11-15";
  samKey = "sh-rsa  sam@optina";

  devKeys = [ volhovmKey georgeeeKey gromakKey gromak2Key flyingleafeKey flyingleafe2Key martoonKey domenKey alanKey jakeKey neongreenKey dshevchenkoKey larsKey philippKey shershKey fersel1Key fersel2Key niklasFPCKey kosergeKey ksaric sectore michaelKey narylKey pva701Key pva7012Key akegaljKey alfredoKey hithrocKey samKey];

  devOpsKeys = [ domenKey georgeeeKey jakeKey jake2Key kosergeKey michaelKey samKey ];
})
